...
[[maybe_unused]] sCuriosity::sCuriosity(std::list<sComandos> comandos, std::list <sElemento> lista_elementos) {
...
[[maybe_unused]] void sCuriosity::setCoordenadas(float coordenada_x, float coordenada_y)
{
    this->coordenadas[0] = coordenada_x;
    this->coordenadas[1] = coordenada_y;
}

[[maybe_unused]] void sCuriosity::setOrientacion(float orientacion) {
    this->orientacion = orientacion;
}

void sCuriosity::simular_comandos(float coordenada_x, float coordenada_y)
{
